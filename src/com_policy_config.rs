// Copied from https://github.com/sidit77/com-policy-config/blob/d8174e9d33a72c24a5ae516094fbcd1f4c8d2b28/src/lib.rs
// to update to latest windows crate.
